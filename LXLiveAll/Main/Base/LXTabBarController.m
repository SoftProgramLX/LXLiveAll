...
- (void)viewDidLoad {
    ...
    [self addOneChlildVc:[[LXHomeController alloc] init] title:@"播放" navigationTitle:@"播放" imageName:nil selectedImageName:nil];
...
- (void)addOneChlildVc:(UIViewController *)childVc title:(NSString *)title navigationTitle:(NSString *)navTitle imageName:(NSString *)imageName selectedImageName:(NSString *)selectedImageName
{
    ...
    selectedTextAttrs[NSForegroundColorAttributeName] = kRedColor;
